...
class RecPlaylistProvider extends ChangeNotifier {
  ...
  late final API _api;
  late final List<Future<List<Song>>> _list;

  List<Map<String, dynamic>> get listInfo => _listInfo;
  ...
  Future<void> getList() async {
    _list = _listInfo.map((info) => _api.search(info['songList'].join(','), SearchType.ids)).toList();
    notifyListeners();
  }
}
